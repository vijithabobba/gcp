...
def chatbotsystem():
    ...
    if request.method == 'POST' and str(request.form['question']) !="":
        ...
        if(questionasked in "Does the college have a football team?"):
            ...
            <label for ="ufname"><strong> The total tuition and living expense budget for in-state Ohio residents is $28,150 and out-state Ohio residents is $45,712</strong></label></br>
            """
            # answergiven = "The total tuition and living expense budget for in-state Ohio residents is $28,150 and out-state Ohio residents is $45,712."
        elif (questionasked in "Does its have on campus housing?"):
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:blue;"><strong>""" + questionasked + """</strong></label></br>
            <label for ="ufname"><strong> Yes!! it has campus housing</strong></label></br>
            """
            # answergiven = "Yes!! it has campus housing"
        else:
            ChatWindowHTMLMiddle = """
            </br><label for="ufname" style="color:blue;"><strong>""" + questionasked + """</strong></label></br>
            <label for ="ufname"><strong> Sorry!! I don't have answer</strong></label></br>
            """
            # answergiven = "Sorry!! I don't have answer"
...
def endchat():
    ...
    [Creator Details]<br>
    <label for="ufname"><strong>Vijita Sagari Bobba, bobbavi@mail.uc.edu</strong></label></br></br>
    """
